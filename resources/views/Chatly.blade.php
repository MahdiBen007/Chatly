<x-app-layout>
    <div x-data="{ selectedUser: null }" class="flex w-full h-screen text-[var(--text)] 
        ...
        <!-- Sidebar -->
        <div id="user-list-sidebar" class="w-full md:w-80 flex-shrink-0 
                   border-r border-gray-300 
                   dark:border-gray-700 
                   bg-white 
                   dark:bg-transparent">
            <x-sidebar :users="$users" :globalRoom="$globalRoom" />
        </div>
    ...
    <script>
        ...
        window.defaultAvatarUrl = @json(asset('images/user.png'));
    </script>
</x-app-layout>